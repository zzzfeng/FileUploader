...
import handle.FileInfoServerHandler;
...
public class Server {
	...
	public static void main(String[] args) throws Throwable {
		...
		acceptor.getFilterChain().addLast("codec", new ProtocolCodecFilter(new FileInfoCodecFactory()));
		acceptor.setHandler(new FileInfoServerHandler()); // 客户端传过来的Message服务器处理。
